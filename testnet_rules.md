...
#### Reward Details - October
The official reward pool size for October was 24,000 Skycoin:
* **12 (12.0) Skycoin / node ; 96 Skycoin per 8 nodes**
</div>
<br>
...
The per node rewards for October are as follows:
- Skycoin price $0.49133382
- **16.249 (16.249273483863583) Skycoin per node reward; 129.994 Skycoin per 8 nodes**
...
Rewards are being paid on a node by node basis. The total amount of rewards is limited by a pool size that is subject to change. The DIY pool size for October was 16,000 Skycoin:
* **6 (6.0) Skycoin / node with a maximum of 8 nodes; 48 Skycoin maximum**
